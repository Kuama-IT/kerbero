...
public class NukiSmartLockControllerTests
{
  ...
  private readonly Mock<IGetNukiAccountInteractor> _authInteractor;
  ...
  public NukiSmartLockControllerTests()
  {
    ...
    _authInteractor = new Mock<IGetNukiAccountInteractor>();
  ...
  {
    // Arrange
    _authInteractor.Setup(a => a.Handle(It.IsAny<GetNukiAccountParams>()))
  ...
  {
    // Arrange
    _authInteractor.Setup(i => i.Handle(It.IsAny<GetNukiAccountParams>()))
