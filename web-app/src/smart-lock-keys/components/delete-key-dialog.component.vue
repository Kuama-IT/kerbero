        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Delete smart-lock key {{ id }}
              </DialogTitle>
              <DialogDescription class="mt-3">
                <p class="text-purple-800">
                  This will revoke the open and close rights from your guests.
                </p>
              </DialogDescription>
              <div class="mt-6">
              ...
              <div class="flex justify-between flex-row-reverse mt-8">
                <button
                  type="button"
                ...
                <button
                  type="button"
                  class="inline-flex justify-center rounded border border-slate-300 px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500"
...
const emit = defineEmits<{
  (e: "onClose", isConfirmed: boolean, id: string): void;
}>();
