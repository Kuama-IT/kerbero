        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NukiSmartLocks_NukiAccounts_NukiAccountId",
                        column: x => x.NukiAccountId,
                        principalTable: "NukiAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NukiSmartLockId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NukiSmartLockStates", x => x.NukiSmartLockId);
                    table.ForeignKey(
                        name: "FK_NukiSmartLockStates_NukiSmartLocks_NukiSmartLockId",
                        column: x => x.NukiSmartLockId,
                        principalTable: "NukiSmartLocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NukiAccounts_ClientId",
                table: "NukiAccounts",
                column: "ClientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NukiSmartLocks_NukiAccountId",
                table: "NukiSmartLocks",
                column: "NukiAccountId");
        }
